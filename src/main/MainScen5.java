...
//		"15000", "5" };
		...
		double time[] = { 32000, 72000, 86400, 129600, 172800, 216000, 512000, 1024000 };
		double emc = 108000;
		double pm = 1;
		double v = 5;
		int rep = 10;
		...
		int dead[][][] = new int[file.length][time.length][rep];
...
//					System.out.println(dead[iter]);
		...
		for (int i = 0; i < time.length; i++) {
			for (int k = 0; k < file.length; k++) {
				outd.print(args[2] + "_" + file[k] + ".txt" + "\t" + Problem.deployedSensors + "\t" + time[i] + "\t");
				double mean = 0;
				double best = 100.0;

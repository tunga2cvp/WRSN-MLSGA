...
//					System.out.println(dead[iter]);
		...
		for (int i = 0; i < v.length; i++) {
			for (int k = 0; k < file.length; k++) {
				outd.print(args[2] + "_" + file[k] + ".txt" + "\t" + Problem.deployedSensors + "\t" + v[i] + "\t");
				double mean = 0;
				double best = 100.0;

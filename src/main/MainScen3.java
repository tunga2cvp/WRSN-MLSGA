...
//				"15000", "5" };
		...
		double emc[] = { 13500, 27000, 54000, 81000, 108000 };
		double pm = 1;
		double v = 5;
		int rep = 10;
...
//					System.out.println(dead[iter]);
		...
		for (int i = 0; i < emc.length; i++) {
			for (int k = 0; k < file.length; k++) {
				outd.print(args[2] + "_" + file[k] + ".txt" + "\t" + Problem.deployedSensors + "\t" + emc[i] + "\t");
				double mean = 0;
				double best = 100.0;
